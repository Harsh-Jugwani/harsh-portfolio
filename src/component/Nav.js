...
function showTaskbar() {
  ...
  return (burgar.style.display = "flex"), (shower.style.display = "none");
}
function closeTaskbar() {
  const burgar = document.querySelector(".burgar");
  const shower = document.querySelector(".shower");

  return (burgar.style.display = "none"), (shower.style.display = "flex");
}
  ...
  return (
    <>
      <nav className="navbar">
        ...
        <a className="buttonadj" href="mailto:hjugwani@gmail.com">
          <button>
            {" "}
            <img src={mes_icon} /> Contact me
          </button>
        </a>
        <a className="hider" onClick={showTaskbar} href="#">
          <svg
