    ...
    <div className="container2">
      ...
      <div className="container-body">
        <section>
          ...
          <br />
          Honored by Madhya Pradesh Chief Minister Shivraj Singh Chouhan under
          the MMVY Yojna <br />
          and Laptop Vitran Yojna ,fostering a commitment to empowering youth
        ...
        <section className="wrap-reverse">
          ...
          <br />
          Achieving excellence, I secured an impressive 98 marks in Mathematics
          in the 10th Board exams, showcasing a strong command of mathematical
          concepts and dedication to academic success.{" "}
        </section>
        <section>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <br />
          Achieving distinction among the top 5% of students, securing TFW
          seats, reflects academic excellence and a notable accomplishment in
          education.
        </section>
      </div>
    </div>
